    ...
    <view class="promotion">
      ...
      <view class="list">
        <view class="column select1" @click="open">
          ...
          <view class="right"
            ><image src="https://img.yuadh.com/imgs/2023/02/05/into.png"></image
          ></view>
        </view>
        <view class="twoBox">
          <view class="column select2">
            <view class="top">
              <view class="title" @click="gotoShow()"
                ><text class="tip">点对点</text>投送</view
              >
            </view>
            <view class="left"> </view>
            <view class="right"
              ><image
                src="https://img.yuadh.com/imgs/2023/02/05/into2.png"
              ></image
            ></view>
          </view>
          <view class="column select3">
            <view class="top">
              <view class="title" @click="gotoShow()"
                ><text class="tip">点对多</text>投送</view
              >
            </view>
            <view class="left"> </view>
            <view class="right"
              ><image
                src="https://img.yuadh.com/imgs/2023/02/05/into3.png"
              ></image
            ></view>
          </view>
        </view>
      ...
      swiperList: [
        {
          id: 1,
          src: "EBoardM系统开发完善中",
          img: "https://img.yuadh.com/imgs/2023/02/05/main3.png",
        },
        {
          id: 2,
          src: "EBoardM系统开发完善中",
          img: "https://img.yuadh.com/imgs/2023/02/05/main1.png",
        },
        {
          id: 2,
          src: "EBoardM系统开发完善中",
          img: "https://img.yuadh.com/imgs/2023/02/05/main2.png",
        },
      ],
      Promotion: [
        {
          title: "添加会议室",
          ad: "输入账号密码加入会议室",
          img: "https://img.yuadh.com/imgs/2023/02/05/into.png",
        },
        {
          title: "单点投屏",
          ad: "输入账号密码加入会议室",
          img: "https://img.yuadh.com/imgs/2023/02/05/into2.png",
        },
